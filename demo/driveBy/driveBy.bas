...
DIM SHARED imgRoad AS INTEGER, imgCar AS INTEGER, imgSky AS INTEGER
imgRoad = LOADIMAGE("road.png")
imgCar = LOADIMAGE("car.png")
imgSky = LOADIMAGE("sky.png")

DIM SHARED turn AS INTEGER, level AS INTEGER, slide AS INTEGER, speed AS INTEGER
DIM lastPeriod AS DOUBLE
DIM lastF AS DOUBLE
lastPeriod = TIMER
lastF = 0
